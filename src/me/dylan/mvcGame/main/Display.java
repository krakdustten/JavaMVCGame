...
public class Display {
    ...
    public Display(int shader, int height, int width){
        this(shader, height, width, 0, 0, 128);
    }

    public Display(int shader, int width, int height, float xPos, float yPos, float zoom){
        this.shader = shader;
